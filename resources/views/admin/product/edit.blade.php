                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid       @enderror" placeholder="Enter Category Name" value="{{ old('name') ?? $product->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="descriprtion" rows="4" class="form-control @error('description') is-invalid       @enderror" placeholder="Product description">{{ old('description') ?? $product->description}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="categories[]" id="" class="form-control select2bs4" multiple>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @if ($product->categories->contains($category)) selected ="selected"
